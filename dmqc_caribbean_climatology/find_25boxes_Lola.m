...
function [ pa_wmo_numbers ] = find_25boxes( pn_float_long, pn_float_lat, pa_wmo_boxes ) ; %pn: profile number, this function is run for each cycle/profile the float has

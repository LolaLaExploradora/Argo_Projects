function edit_argo_qc_new_Lola1(wmonum, np, windowOption, cycleRangeStart, cycleRangeEnd)
%function edit_argo_qc_new(wmonum,np)
...
overwrite=[];
fetch_from_gdac_Lola(wmonum,GDAC,QC1,overwrite,cycleRangeStart,cycleRangeEnd)  % move files from GDAC mirror to QC1
